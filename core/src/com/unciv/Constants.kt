...
object Constants {
    ...
    /** Public source snapshot for the distributed Deciv build. */
    const val decivSourceURL = "https://github.com/Cognerva/deciv-source/"
    /** URL to the wiki, including trailing slash */
    const val wikiURL = "https://yairm210.github.io/Unciv/"

    const val supportEmail = "support@cognerva.com"
    const val supporterProductId = "com.cognerva.unciv.supporter"
    const val smallTipProductId = "com.cognerva.unciv.tip.small"
    const val largeTipProductId = "com.cognerva.unciv.tip.large"
    const val patronTipProductId = "com.cognerva.unciv.tip.patron"

    val storeProductIds = setOf(
        supporterProductId,
        smallTipProductId,
        largeTipProductId,
        patronTipProductId
