...
internal class DisplayTab(
    ...
    private fun addScreenModeSelectBox() {
        ...
        // Platforms such as iOS do not expose user-selectable window modes.
        // Do not create a SelectBox without an item or a fallback value.
        val fallbackMode = modes.values.firstOrNull() ?: return
        val proxy = object {
            var value: ScreenMode
                get() = modes[settings.screenMode] ?: fallbackMode
