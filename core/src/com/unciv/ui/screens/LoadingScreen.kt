...
class LoadingScreen(
    ...
    private fun takeScreenshot(previousScreen: BaseScreen?): Texture {
        ...
        val viewportLeft = HdpiUtils.toBackBufferX(viewport.screenX)
        val viewportBottom = HdpiUtils.toBackBufferY(viewport.screenY)
        val viewportRight = HdpiUtils.toBackBufferX(viewport.screenX + viewport.screenWidth)
        val viewportTop = HdpiUtils.toBackBufferY(viewport.screenY + viewport.screenHeight)
