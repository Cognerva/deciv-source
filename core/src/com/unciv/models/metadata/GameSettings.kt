...
class GameSettings {
    ...
    /** Keep iOS content inside the safe area around the Dynamic Island and home indicator. */
    var iosSafeAreaInsets = true
    var fontFamilyData: FontFamilyData = FontFamilyData.default
    var fontSizeMultiplier: Float = 0.7f
    var longPressDelay = 1.1f
    var multiTapInterval = 0.25f

    /** Cached entitlement state; StoreKit remains the source of truth when available. */
    var supporterUnlocked = false
    /** Product IDs that have been observed as purchased or restored on this device. */
    var ownedProductIds = HashSet<String>()
    var tipTotalMinorUnits = 0
    var selectedAlternateAppIcon: String? = null
