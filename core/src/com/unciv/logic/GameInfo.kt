...
class GameInfo : IsPartOfGameInfoSerialization, HasGameInfoSerializationVersion {
    ...
    fun isUnavailableBySettingsCached(obj: IHasUniques): Boolean {
        settingsUnavailability[obj]?.let { return it }
        val computed = obj.isUnavailableBySettings(this)
        return settingsUnavailability.putIfAbsent(obj, computed) ?: computed
    }
    ...
    fun calculateChecksum(): String {
        ...
        val bytes = sha1(json().toJson(this).toByteArray(Charsets.UTF_8))
