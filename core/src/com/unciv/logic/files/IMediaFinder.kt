...
interface IMediaFinder {
    ...
    open class Sounds : IMediaFinder {
        ...
        protected companion object {
            // Keep this explicit instead of using Kotlin reflection. RoboVM's KClass
            // implementation cannot support kotlin.reflect.full.declaredMemberProperties.
            fun uncivSoundNames() = sequenceOf(
                UncivSound.Bombard,
                UncivSound.Chimes,
                UncivSound.Choir,
                UncivSound.Click,
                ...
                UncivSound.Fire,
                UncivSound.Fortify,
                UncivSound.Notification1,
                UncivSound.Notification2,
                UncivSound.Paper,
                UncivSound.Policy,
                UncivSound.Promote,
                UncivSound.Setup,
