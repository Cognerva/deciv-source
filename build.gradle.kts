...
project(":core") {
    ...
    dependencies {
        "implementation"(rootProject.libs.gdx)
        "implementation"(rootProject.libs.coroutines.core)
        // The iOS/RoboVM target has no java.time runtime. These types are part of
        // core's public model/API, so expose the compatible ThreeTen backport to
        // every platform and test consumer.
